  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-sm-2 pull-right" style="margin-right:1px;">
        <a class="btn pull-right btn-primary" href="<?= base_url('dropdown/add/skills'); ?>"><i class="fa fa-plus"></i> Add Skills</a>
      </div>
    </div>
    <div class="row">
                        ...
                        <div class="btn-group">
                          ...
                          <ul role="menu" class="dropdown-menu">
                            <?php if ($item['status'] === "Inactive") { ?>
                              <li><a href="<?= base_url("dropdown/ch_status/skills/{$item['id']}/1"); ?>"><i class="fa fa-check"></i> Make as Active</a></li>
                            <?php } else { ?>
                              <li><a href="<?= base_url("dropdown/ch_status/skills/{$item['id']}/0"); ?>"><i class="fa fa-ban"></i> Make as Inactive</a></li>
                            <?php } ?>
                            <li><a href="<?= base_url("dropdown/add/skills/{$item['id']}"); ?>"><i class="fa fa-edit"></i> Edit</a></li>
                            <li><a href="#" class="delete-btn" data-toggle="modal" data-action="dropdown/delete/<?= $item['id']; ?>/skills" data-name="<?= $item['name']; ?>" data-target=".bs-example-modal-sm"><i class="fa fa-trash"></i> Delete</a></li>
                          </ul>
                        </div>
                      </td>
                    </tr>

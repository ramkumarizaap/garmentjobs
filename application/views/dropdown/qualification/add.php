  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Add Qualification for Applicant</h3>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form class="form-horizontal" novalidate method="post" action="<?= base_url('dropdown/add/qualification'); ?>">
              ...
              <div class="form-group">
                <div class="col-md-6 col-md-offset-3">
                  <a href="<?= base_url('dropdown/qualification'); ?>" class="btn btn-primary">Cancel</a>

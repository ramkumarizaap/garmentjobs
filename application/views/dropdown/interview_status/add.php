  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Interview Status Info</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-horizontal" novalidate method="post" action="<?= base_url('dropdown/add/interview_status'); ?>">
              ...
              <div class="form-group">
                <div class="col-md-6 col-md-offset-3">
                  <a href="<?= base_url('dropdown/skills'); ?>" class="btn btn-primary">Cancel</a>
